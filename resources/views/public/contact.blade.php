    ...
    <div class="bg-white lg:rounded-2xl dark:bg-[#111111]">
        ...
        <div
            ...
            <h3 class="text-4xl">
                ...
                <span class="text-gray-lite dark:text-[#A6A6A6]">Siempre dispuestos a discutir el producto.</span>
                <br />
                <span class="font-semibold dark:text-white">Trabajamos en desarrollo de aplicaciones.</span>
            </h3>
