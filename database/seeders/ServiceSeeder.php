...
class ServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Service::create([
            ...
            'logo_url' =>'https://bkportafolio.test/images/icons/icon3.svg',
            'color_hex' =>'#fff4f4'
        ]);
        Service::create([
            'title' =>'Consultoría',
            'description' =>'Con mas de 15 años en el mundo profesional tecnológico, ayudo a empresas a crecer tecnológicamente.',
            'logo_url' =>'https://bkportafolio.test/images/icons/icon4.svg',
            'color_hex' =>'#fff0f8'
        ]);
        Service::create([
            ...
            'logo_url' =>'https://bkportafolio.test/images/icons/icon5.svg',
            'color_hex' =>'#f3faff'
        ]);
